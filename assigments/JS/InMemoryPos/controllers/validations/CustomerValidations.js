...
const CUS_Age_REGEX = /^(?:[0-9]|[1-9][0-9]|1[0-4][0-9]|150)$/;
...
c_vArray.push({field: $("#txtCustomerAge"), regEx: CUS_Age_REGEX});
...
function clearCustomerInputFields() {
    $("#txtCustomerID,#txtCustomerName,#txtCustomerAge,#txtCustomerAddress,#txtCustomerSalary").val("");
    $("#txtCustomerID,#txtCustomerName,#txtCustomerAge,#txtCustomerAddress,#txtCustomerSalary").css("border", "1px solid #ced4da");
    $("#txtCustomerID").focus();
    setBtn();
}
setBtn();
...
//disable tab
$("#txtCustomerID,#txtCustomerName,#txtCustomerAge,#txtCustomerAddress,#txtCustomerSalary").on("keydown keyup", function (e) {
